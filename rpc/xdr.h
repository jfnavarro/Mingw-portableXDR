...
struct XDR{
	...
	struct xdr_ops {
		...
		bool_t (*x_putlong) (XDR *__xdrs, __const long *__lp);/* get a long from underlying stream */
		bool_t (*x_getbytes) (XDR *__xdrs, caddr_t __addr, u_int __len);/* put a long to " */
		bool_t (*x_putbytes) (XDR *__xdrs, __const char *__addr, u_int __len);/* get some bytes from " */
		u_int (*x_getpostn) (__const XDR *__xdrs);/* put some bytes to " */
		bool_t (*x_setpostn) (XDR *__xdrs, u_int __pos);/* returns bytes off from beginning */
		int32_t *(*x_inline) (XDR *__xdrs, u_int __len);/* lets you reposition the stream */
		void (*x_destroy) (XDR *__xdrs);/* buf quick ptr to buffered data */
		bool_t (*x_getint32) (XDR *__xdrs, int32_t *__ip);/* free privates of this xdr_stream */
		bool_t (*x_putint32) (XDR *__xdrs, __const int32_t *__ip);/* get a int from underlying stream */
	} *x_ops;
...
extern bool_t xdr_union (XDR *__xdrs, int32_t *__dscmp, char *__unp,
